...
def fedpredict_client(filename, model, global_parameters, t, T, nt,  decompress, M, mode=None, local_classes=1):
    # Using 'torch.load'
    try:
        if mode == "kd":
...
def fedpredict_dynamic_client(filename, model, global_parameters, t, T, nt, decompress, M, mode=None, local_client_information={}, current_proportion=None):
    # Using 'torch.load'
    try:
