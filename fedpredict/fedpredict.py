...
def fedpredict_client_traditional(local_model: torch.nn.Module, global_parameters: list[np.array],
...
def fedpredict_dynamic_client(local_model: torch.nn.Module, global_parameters: list[np.array],
